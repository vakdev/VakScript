...
from numpy import dot, array, frombuffer, float32
#own
...
class World:
    ...
    def get_view_proj_matrix(self):
        ...
        view_proj_matrix = dot(view_matrix, proj_matrix)
        return view_proj_matrix
    
    def world_to_screen(self, view_proj_matrix, x, y, z):
        clip_coords = dot(array([x, y, z, 1.0]), view_proj_matrix.reshape(4, 4))
